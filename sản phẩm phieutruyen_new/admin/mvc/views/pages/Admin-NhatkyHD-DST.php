    ...
    <div class="tabs">
        ...
        <div class="row tab" style="height: 1280px;">
            <div class="row-1 cmd-btn">
                ...
                <button class="story-item-btn" onclick="location.href='?url=comic'">
            ...
            <div class="row workspace" style="height: 95%;">
                <div class="listchapter">
                    ...
                    <?php foreach ($data['nkhd'] as $nkhd): ?>
                        <?php if ($nkhd['status_chapter'] == 'Đã duyệt'): ?> 
                        <li>
                            <div class="row story-block-item">
                                ...
                                <div class="col-9" style="width: 79%;">
                                    <div class="row-3 story-block-item-detail">
                                        ...
                                        <p>Hoạt động: Đã duyệt chương <?= $nkhd['index_chapter']?></p>
                                    </div>
                                </div>
        ...
        <label for="StoryList">Danh sách truyện</label></a>
        <div class="row tab" style="height: 1280px;">
            <!--The loai-->
            ...
            <!--Tinh trang-->
                <div class="categories" id="Tinh-trang">
                    ...
                    <div class="fcategory">
                        <input type="checkbox" name="q2" id="cCompleted">
                        <label for="q">Đã hoàn thành</label>
                    </div>
                    <div class="fcategory">
                        <input type="checkbox" name="q2" id="cInProgress">
                        <label for="q">Đang tiến hành</label>
                    </div>
                    <div class="fcategory">
                        <input type="checkbox" name="q2" id="cDropped">
                                ...
                                <div class="row story-block-item">
                                    ...
                                    <div class="col-9" style="width: 79%;">
                                        <div class="row-3 story-block-item-detail">
                                            ...
                                            <p>Người đăng: <?= $comic['account_name']?></p>
