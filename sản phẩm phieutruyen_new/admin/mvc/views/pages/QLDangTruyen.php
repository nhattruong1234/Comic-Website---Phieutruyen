                                ...
                                <div class="row story-block-item">
                                    ...
                                    <div class="col-9" style="width: 79%;">
                                        ...
                                        <div class="row-1 story-block-item-btn">
                                            ...
                                            <a href="?url=post_comic/delete_chapter/<?= $chapter['id'] ?>" onclick="return confirm('Bạn muốn xóa chương này khỏi danh sách chờ duyệt?');" style="text-decoration: none">
                                            <button class="story-item-btn">
                                                <i style="color: #212529;" class='bx bxs-trash'></i>
                                                <p style="color: #212529;">Xóa</p>
                                            </button></a>
                                            <button class="story-item-btn" onclick="location.href='./../read.php?comic=<?= $chapter['id_comic'] ?>&chapter=<?= $chapter['index']; ?>'">
                                                <i class='bx bx-book-reader'></i>
                                                <p>Đọc thử</p>
                                            </button>
                                        </div>
