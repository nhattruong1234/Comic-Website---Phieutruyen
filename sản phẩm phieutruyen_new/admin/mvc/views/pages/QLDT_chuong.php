        ...
        <div class="row tab" style="height: 1280px; ">     
                ...
                <div class="row workspace" style="height: 60%;">
                    <div class="listchapter">
                        <ul class="col">
                        <?php  foreach ($data['comic_chapter'] as $post_comic): ?>    
                            <?php if ($post_comic['status'] == 'Chờ duyệt'): ?>                                                                     
                            <li>
                                <div class="row story-block-item">
                                    ...
                                    <div class="col-9" style="width: 79%;">
                                        ...
                                        <div class="row-1 story-block-item-btn">
                                            <a style="text-decoration: none" href="?url=post_comic/duyet_chuong/<?= $post_comic['id'] ?>" onclick="return confirm('Bạn muốn duyệt truyện?');">
                                            ...
                                            <button class="story-item-btn" onclick="location.href='./../read.php?comic=<?= $post_comic['id_comic'] ?>&chapter=<?= $post_comic['index']; ?>'">
