    ...
    <body>
        ...
        <div class="contentQLTK container-xxl" id="content">
            ...
            <div class="account-info" id="acc-info">
                ...
                <!--account info detail-->
                <form class="account-info-detail" id="acc-info-detail">
                    <input type="text" class="form-control" aria-label="Disabled input example" readonly value="aaaaaaa" id="acc-username">
                    <input type="text" class="form-control" placeholder="Tên người dùng" id="acc-name">
                    <input type="text" class="form-control" placeholder="Email" id="acc-email">
                    <div class="container d-flex flex-row justify-content-between" style="padding: 0;">
                        <input type="date" class="form-control" placeholder="Ngày sinh" id="acc-dob">
                        <select class="form-select" style="max-width: 400px;" id="acc-sex">
                    ...
                    <input type="text" class="form-control" placeholder="UID" readonly id="acc-uid">
                    <input type="text" class="form-control" placeholder="Facebook" id="acc-fb">
                </form>
                <!--change-password-->
                <div class="change-password container d-flex flex-column" id="c-password">
                    <input type="password" class="form-control" id="inputPassword0" placeholder="Mật khẩu hiện tại">
                    <input type="password" class="form-control" id="inputPassword1" placeholder="Nhập mật khẩu mới">
                    <input type="password" class="form-control" id="inputPassword2" placeholder="Nhập lại mật khẩu mới">
